...
$config->custom->session['blowfish'] = '941d5531f7f93eabd8311cde98ea6f61';  # Autogenerated for ldapserver.mpw.com
...
$servers->setValue('server','host','192.168.56.102');
...
$servers->setValue('server','base',array('dc=mpw,dc=com'));
